 ...
 * @author facun
 */
public class ConfirmarEliminarVendedorJFrame1 extends javax.swing.JFrame {

    /**
     * Creates new form PersonaJFrame
     */
    public ConfirmarEliminarVendedorJFrame1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Esta seguro que desea eliminar el vendedor?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmarEliminarVendedorJFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmarEliminarVendedorJFrame1().setVisible(true);
            }
        });
    }
