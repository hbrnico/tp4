 ...
 * @author facun
 */
public class ConfirmarEliminarItemMenuJFrame11 extends javax.swing.JFrame {

    /**
     * Creates new form PersonaJFrame
     */
    public ConfirmarEliminarItemMenuJFrame11() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jToggleButton2.setBackground(new java.awt.Color(96, 86, 120));
        ...
        jLabel1.setText("¿Esta seguro que desea eliminar el item?");

        jToggleButton3.setBackground(new java.awt.Color(96, 86, 120));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmarEliminarItemMenuJFrame11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmarEliminarItemMenuJFrame11().setVisible(true);
            }
        });
    }
